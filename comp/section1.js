...
const Section1= () => {
  return (
    <div className="relative mb-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12">
        <div className="col-span-1 lg:col-span-7 bg-backgray lg:h-[925px] justify-center flex flex-col lg:pl-32 px-16 items-center lg:items-start">
          <h2 className="font-bold text-7xl mt-10">Search, Find, & Apply</h2>
          <p className="text-left text-2xl w-9/12 my-14">
  ...
  <div className="relative flex items-center flex-grow h-[60px]">
    <div
    ...
    <input
      type="text"
      className="pl-10 bg-lightgray rounded-md w-full h-full placeholder:text-black text-xl"
      placeholder="Job title or keyword"
    />
  </div>
  <div className="relative flex items-center flex-grow ml-6 h-[60px]">
    <div
    ...
    ></div>
    <select className="pl-10 bg-lightgray text-black text-2xl rounded-md w-full h-full">
  ...
  <button
    type="submit"
    className="bg-maingreen text-white font-bold text-xl ml-6 px-9 py-[15px] rounded-xl"
  >
    Search
  </button>
</form>
        </div>
        <div className="col-span-1 lg:col-span-5 bg-backgray lg:h-[925px] ">
