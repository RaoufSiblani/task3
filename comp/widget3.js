const Wid3 = ({ imageSrc, heading ,company }) => {
    return (
      <div className="bg-white rounded-xl mr-12 w-[580px] h-[670px] pl-10 pr-12 flex flex-col">
        ...
        <h2 className="font-bold text-3xl flex pt-10">{heading}</h2>
        <h3 className="font-bold text-xl text-gray-500 flex pt-5 pb-10">{company}</h3>
        <p className="text-left text-base text-textgray flex">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed quis lacus non
  ...
  <div className="bg-backgray flex items-center mr-2 p-2 rounded-xl">
    ...
    <p className="text-xl">San Fransisco,CA</p>
    </div>
    <div className="bg-backgray flex items-center mr-2 p-2 rounded-xl">
...
<p className="text-maingreen text-4xl">Apply Now &gt;</p>
      </div>
    );
  };
