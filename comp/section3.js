  ...
  return (
    <div className="px-8 lg:py-20 py-5 grid grid-cols-12 items-center justify-center 2xl:container 2xl:mx-auto">
      ...
      <div className="flex flex-col items-center lg:items-start lg:ml-20 lg:mr-20 lg:col-span-7 col-span-12">
        <h2 className="font-bold text-2xl lg:text-4xl mt-10 leading-tight text-center lg:text-left">We will help you to become an employee in your dream company</h2>
        <div className="my-10">
          <p className="text-xl lg:text-2xl text-textgray text-center lg:text-left">
