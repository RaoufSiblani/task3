  ...
  return (
    <div className="px-16 lg:pl-32 my-48 flex flex-col lg:flex-row items-center justify-center">
      ...
      <div className="flex flex-col items-center lg:items-start lg:ml-20 lg:mr-32">
        <h2 className="font-bold text-5xl mt-10 leading-tight text-center lg:text-left">We will help you to become an employee in your dream company</h2>
        <div className="my-10">
          <p className="text-3xl text-textgray text-center lg:text-left">
        ...
        <div className="flex flex-grow">
          <button className="bg-white text-maingreen border border-maingreen px-7 py-4 rounded-xl font-bold text-2xl items-center">
