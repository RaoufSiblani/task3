...
const Section2 = () => {
  ...
  return (
    <div className="mt-48 w-full px-32">
      <h2 className="font-bold text-5xl mt-10">How it works</h2>

      <div className="flex items-center">
        <div className="w-full lg:my-14 lg:w-7/12">
          <p className="text-left text-2xl text-textgray py-6 lg:py-0">
        ...
        <div className="hidden justify-end flex-grow lg:flex">
          <button className="bg-white text-maingreen border border-maingreen px-7 py-4 rounded-xl font-bold text-3xl items-center">
